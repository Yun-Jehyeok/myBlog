...
// FIND USER PASSWORD
export const FIND_USER_PASSWORD_REQUEST = "FIND_USER_PASSWORD_REQUEST";
export const FIND_USER_PASSWORD_SUCCESS = "FIND_USER_PASSWORD_SUCCESS";
export const FIND_USER_PASSWORD_FAILURE = "FIND_USER_PASSWORD_FAILURE";
